...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/Draven-Lee/COVCTR/settings). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
...
The COV-CTR dataset consists 728 images (349 for COVID-19 and 379 for Non-COVID) collected from published papers and their corresponding paired Chinese reports. 
